...
function emoji(){}
    ...
    emoji.replace_colons = function(str, submit){
        emoji.init_colons();
        return str.replace(emoji.rx_colons, function(m){
            var idx = m.substr(1, m.length-2);
            if (idx === 'shipit') var val = 'shipit';
            else if (idx === 'metal') var val = 'metal';
            else var val = emoji.map.colons[idx];
            return val ? emoji.replacement(val, idx, ':', submit) : m;
        });
    };
    ...
    emoji.replace_unified_with_colons = function(str){
        ...
        return str.replace(emoji.rx_unified, function(m){
            var val = emoji.map.unified[m];
            return val ? emoji.replacement(val, false, ':', false, true) : m;
        });
    };

    emoji.replacement = function(idx, actual, wrapper, submit, text){
        if (idx === 'shipit') {
            emoji.data[idx] = [];
            emoji.data[idx][3] = [];
            emoji.data[idx][3][0] = 'shipit';
        } else if (idx === 'metal') {
            emoji.data[idx] = [];
            emoji.data[idx][3] = [];
            emoji.data[idx][3][0] = 'metal';
        }
        wrapper = wrapper || '';
        var text_name = (actual) ? wrapper+actual+wrapper : emoji.data[idx][6] || wrapper+emoji.data[idx][3][0]+wrapper;
        if (text || emoji.text_mode || (idx === 'shipit' && submit) || (idx === 'metal' && submit)) return text_name;
        emoji.init_env();
        if ((submit || emoji.replace_mode == 'unified') && emoji.allow_native && emoji.data[idx][0]) return emoji.data[idx][0];
    ...
    emoji.data = {
        ...
        "1f44b":["\uD83D\uDC4B","\uE41E","\uDBBA\uDF9D",["wave"],13,20],
        "1f44c":["\uD83D\uDC4C","\uE420","\uDBBA\uDF9F",["ok_hand", "okhand"],13,21],
        "1f44d":["\uD83D\uDC4D","\uE00E","\uDBBA\uDF97",["+1","thumbsup", "plus"],13,22],
        ...
        "1f47c":["\uD83D\uDC7C","\uE04E","\uDBB8\uDDAF",["angel"],15,9],
        "1f47d":["\uD83D\uDC7D","\uE10C","\uDBB8\uDDB0",["alien"],15,10],
        "1f47e":["\uD83D\uDC7E","\uE12B","\uDBB8\uDDB1",["space_invader", "spaceinvader"],15,11],
        "1f47f":["\uD83D\uDC7F","\uE11A","\uDBB8\uDDB2",["imp"],15,12],
        "1f480":["\uD83D\uDC80","\uE11C","\uDBB8\uDDB3",["skull"],15,13],
        ...
        "1f494":["\uD83D\uDC94","\uE023","\uDBBA\uDF0E",["broken_heart"],16,3],
        "1f495":["\uD83D\uDC95","\uE327","\uDBBA\uDF0F",["two_hearts"],16,4],
        "1f496":["\uD83D\uDC96","\uE327","\uDBBA\uDF10",["sparkling_heart"],16,5],
        "1f497":["\uD83D\uDC97","\uE328","\uDBBA\uDF11",["heartpulse"],16,6],
        "1f498":["\uD83D\uDC98","\uE329","\uDBBA\uDF12",["cupid"],16,7],
        "1f499":["\uD83D\uDC99","\uE32A","\uDBBA\uDF13",["blue_heart"],16,8],
        "1f49a":["\uD83D\uDC9A","\uE32B","\uDBBA\uDF14",["green_heart"],16,9],
        "1f49b":["\uD83D\uDC9B","\uE32C","\uDBBA\uDF15",["yellow_heart"],16,10],
        "1f49c":["\uD83D\uDC9C","\uE32D","\uDBBA\uDF16",["purple_heart"],16,11],
        ...
        "1f4ad":["\uD83D\uDCAD","","",["thought_balloon", "thoughtballoon"],16,28],
        ...
        "1f52e":["\uD83D\uDD2E","\uE23E","\uDBB9\uDCF7",["crystal_ball", "crystalball"],21,3],
        ...
        "1f61c":["\uD83D\uDE1C","\uE105","\uDBB8\uDF29",["stuck_out_tongue_winking_eye"],23,16],
